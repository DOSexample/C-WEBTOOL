...
#define SSA_NOKASHIDA 0x80000000
  ...
  HRESULT WINAPI ScriptStringAnalyse(HDC hdc,const void *pString,int TCCString,int cGlyphs,int iCharset,DWORD dwFlags,int iReqWidth,SCRIPT_CONTROL *psControl,SCRIPT_STATE *psState,const int *piDx,SCRIPT_TABDEF *pTabdef,const BYTE *pbInClass,SCRIPT_STRING_ANALYSIS *pssa);
